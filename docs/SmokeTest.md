...
- [ ] Scroll to the end of the latest list. Confirm another page loads or a clear no-more-results state is shown.
...
- [ ] Scroll to the end. Confirm the next search page is appended without duplicate or reordered cards.
...
| --- | --- | --- | --- | --- | --- |
| NHentai | ____ | ____ | ____ | ____ | WebView clearance may be required |
| HenTag | ____ | ____ | ____ | ____ |  |
| MangaDex | ____ | ____ | ____ | ____ |  |
| EHentai | ____ | ____ | ____ | ____ | Requires Zenith server at `192.168.0.248:1313` |
...
Failed or blocked step IDs: __________________________________________

Evidence locations: _________________________________________________
